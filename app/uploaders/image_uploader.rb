...
class ImageUploader < Shrine
  ...
  Attacher.validate do
    validate_max_size 64.megabytes, message: 'is too large (max is 64 MB)'
    validate_mime_type_inclusion ['image/jpeg', 'image/png', 'image/gif','image/bmp','image/x-windows-bmp']
  end
